...
public class TESTES {
    public static void main(String[] args) {
        ...
        ESConfig esConfig1 = new ESConfig("es-yao", "192.168.99.41:9300,192.168.99.42:9300");
        QueryFromES queryFromES = new QueryFromES(esConfig1);
        ESAdminOperations esAdminOperations = new ESAdminOperations(esConfig1);
