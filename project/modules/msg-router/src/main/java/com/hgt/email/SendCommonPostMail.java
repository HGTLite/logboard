...
public class SendCommonPostMail {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String apiUser = "uptonking_test_FXRFvh";
        final String apiKey = "loRzHdmW211FalBl";
        ...
        params.add(new BasicNameValuePair("to", "837276086@qq.com"));
